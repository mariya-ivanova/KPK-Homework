...
namespace _04.InheritanceAndPolymorphism
{
    abstract class Course
    {
        ...
        internal string Name
        {
            ...
            set
            {
                Validator.ValidateIfNullOrEmpty(value, "Course name can not be an empty string");
                this.name = value;
            }
        }
        ...
        internal string TeacherName
        {
            ...
            private set
            {
                Validator.ValidateIfNullOrEmpty(value, "Teacher name can not be an empty string");
